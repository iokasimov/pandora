...
module Pandora.Paradigm.Primary.Algebraic (module Exports, Applicative, Alternative, Divisible, Extractable, Pointable, ($>-), ($$>-), ($$$>-), (<-*-), (*>-), forever_, (-+-), void, empty, point, extract) where
