...
import Pandora.Paradigm.Structure.Ability.Morphable (Morphable, Morph (Find, Element))
import Pandora.Paradigm.Inventory.State (State, modify)
import Pandora.Paradigm.Controlflow.Effect (run)

type Set t a = (Traversable t, Setoid a, Setoid (t a), Morphable (Find Element) t)
