...
import Pandora.Pattern.Functor.Applicative (Applicative ((<*>), (<**>)), Semimonoidal_)
...
instance (Traversable t (->) (->), Bindable t (->), Semimonoidal_ u (->) (:*:) (:*:), Pointable u (->), Bindable u (->)) => Bindable (t <.:> u) (->) where
